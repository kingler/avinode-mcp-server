...
-- Complete Aviation Platform Database Schema - FIXED VERSION
...
-- Insert sample flight legs (using actual aircraft UUIDs from your database)
...
SELECT 'Complete Aviation Platform Database Created Successfully!' as status,
       'All 15 tables created with proper UUID foreign keys' as details,
