-- =====================================================
-- COMPLETE DATABASE SCHEMA FOR AVINODE PLATFORM
-- Creates all missing tables for Avinode, Paynode, and SchedAero integration
-- =====================================================

-- 1. OPERATORS TABLE (Missing for Avinode)
...
-- 2. FLIGHT_LEGS TABLE (Missing for Avinode)
...
-- 3. PRICING_QUOTES TABLE (Missing for Avinode)
...
-- 4. CHARTER_REQUESTS TABLE (Missing for Avinode)
...
-- 5. TRANSACTIONS TABLE (Missing for Paynode)
...
-- 6. INVOICES TABLE (Missing for Paynode)
...
-- 7. MAINTENANCE_RECORDS TABLE (Missing for SchedAero)
...
-- 8. CREW_ASSIGNMENTS TABLE (Missing for SchedAero)
...
-- 9. AIRCRAFT_REVIEWS TABLE (Missing for SchedAero)
...
-- 10. OPERATOR_REVIEWS TABLE (Missing for SchedAero)
...
-- 11. MARKET_ANALYTICS TABLE (Missing for Analytics)
...
-- 12. PRICE_PREDICTIONS TABLE (Missing for AI)
...
-- 13. DEMAND_FORECASTS TABLE (Missing for AI)
...
-- 14. REAL_TIME_ALERTS TABLE (Missing for Real-time)
...
-- 15. NOTIFICATION_PREFERENCES TABLE (Missing for Real-time)
